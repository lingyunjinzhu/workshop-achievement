local assets =
{
    ...
    Asset("ATLAS", "images/inventoryimages/redlantern2.xml"),
    Asset("IMAGE", "images/inventoryimages/redlantern2.tex"),
}
...
local function fn()
    ...
    inst.components.inventoryitem.imagename = "redlantern2" -- Use our TEX sprite
    inst.components.inventoryitem.atlasname = "images/inventoryimages/redlantern2.xml"
    ...
    inst.components.fueled:InitializeFuelLevel(TUNING.REDLANTERN_LIGHTTIME/20)
...
return Prefab("redlantern2", fn, assets, prefabs)